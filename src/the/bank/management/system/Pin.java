...
public class Pin extends JFrame implements ActionListener{
    ...
    Pin(String pin){
        ...
        t1.setFont(new Font("Raleway", Font.BOLD, 23));
        
        t2 = new JPasswordField();
        t2.setFont(new Font("Raleway", Font.BOLD, 23));
        ...
        t1.setBounds(240,295,130,20);
        l4.add(t1);
        
        t2.setBounds(240,325,130,20);
        l4.add(t2);
        
        b1.setBounds(290,430,100,25);
        l4.add(b1);
        
        b2.setBounds(290,460,100,25);
        l4.add(b2);
